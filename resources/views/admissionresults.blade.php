...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen  sm:items-center py-4 sm:pt-0" style="background-color:#cbd5e0 ;">
        ...
        <div class="py-12" style="padding-top:70px">
            <p>Year: 2022</p>
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <table>
                        <tr>
                            <th style="border-bottom: 1px solid #ddd;padding: 60px;text-align: left;">ID</th>
                            <th style="border-bottom: 1px solid #ddd; padding: 60px;text-align: left;">Name</th>
                            <th style="border-bottom: 1px solid #ddd; padding: 60px;text-align: left;">Remarks</th>
                        </tr>
                    </table>
                    @foreach($admissionresults as $r)
                    <table>
                        <tr>
                            <td style="border-bottom: 1px solid #ddd;padding: 30px;text-align: left;">{{$r->id}}</td>
                            <td style="border-bottom: 1px solid #ddd;padding: 30px;text-align: left;">{{$r->name}}</td>
                            <td style="border-bottom: 1px solid #ddd;padding: 30px;text-align: left;">{{$r->remarks}}</td>
                        </tr>
                    </table>
                    @endforeach
                </div>
